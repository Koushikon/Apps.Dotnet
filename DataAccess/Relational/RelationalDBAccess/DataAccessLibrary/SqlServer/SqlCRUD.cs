...
namespace DataAccessLibrary.SqlServer
{
    public class SqlCRUD
    {
        ...
        public dynamic ContactAdd(string firstName, string lastName)
        {
            var parameters = new DynamicParameters();
            parameters.Add("FirstName", firstName);
            parameters.Add("LastName", lastName);
            parameters.Add("ContactId", dbType: DbType.Int32, direction: ParameterDirection.Output);
            parameters.Add("ContactMsg", dbType: DbType.String, direction: ParameterDirection.Output, size: 200);

            var data = _db.ExecuteStoredProcedure("ContactInsert", parameters, _connectionString);
            return data;
        }
    }
}
